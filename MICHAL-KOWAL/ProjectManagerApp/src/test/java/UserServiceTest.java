...
public class UserServiceTest {
    ...
    void testDeleteUser() {
        ...
        project1.setUsers(projectUsers);

        when(userRepository.existsById(1L)).thenReturn(true);
        when(userRepository.findById(1L)).thenReturn(Optional.of(user1));
        when(projectRepository.findByUsers_Id(1L)).thenReturn(Arrays.asList(project1));
        ...
        verify(projectRepository, times(1)).findByUsers_Id(1L);
